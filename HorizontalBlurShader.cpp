...
void HorizontalBlurShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthmap, XMFLOAT2 screensize)
{
	...
	widthPtr->screenWidth = screensize.x;
	widthPtr->centrex = screensize.x/2;
	widthPtr->centrey = screensize.y/ 2;
	widthPtr->padding = 0;
